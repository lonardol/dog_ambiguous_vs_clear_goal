...
load("./workspaces/dwell_time_react_IP.RData")
```

# Import data - reaction IP 
Duration: the last 13200 ms 
...
which(is.na(reaction.ip.data$TRIAL_DWELL_TIME)) 
...
hist(dwell.descr.react$ia_dwell_time_log)
